...
public class food_data {
    ...
    public void add_food_data_meat() {
        food.add_meat("Chicken, roasting, light meat, meat only, raw", 22.2, 1.1, 109, 57);
        food.add_meat("Chicken, dark meat, drumstick, meat and skin, with added solution, cooked, roasted", 24.72, 9.00, 180, 128);
        food.add_meat("Turkey, dark meat, meat only, with added solution, cooked, roasted", 26.10, 5.4, 158, 105);
        food.add_meat("Duck, domesticated, meat and skin, cooked, roasted", 18.99, 25, 337, 84);
        food.add_meat("Lamb, variety meats and by-products, tongue, raw", 15.7, 16, 222, 156);
        food.add_meat("Fried Chicken, Thigh, meat only, skin and breading removed", 23.21, 6, 178, 125);
        food.add_meat("Fried Chicken, Drumstick, meat only, skin and breading removed", 26.24, 6.6, 172, 133);
        food.add_meat("Fried Chicken, Wing, meat only, skin and breading removed", 28.77, 9, 215, 148);
    ...
    public void add_food_data_vegetalbe() {
        ...
        food.add_vegetable("CAMPBELL'S CHUNKY Soups, Chicken Broccoli Cheese & Potato Soup", 2.86, 1.633, 86, 0);
        food.add_vegetable("Avocados, raw, California", 1.96, 13.3, 167, 0);
        food.add_vegetable("Vegetables, mixed (corn, lima beans, peas, green beans, carrots) canned, no salt added", 1.40, 0.15, 37, 0);
        food.add_vegetable("Carrots, raw", 0.93, 0.168, 41, 0);
        food.add_vegetable("Carrots, cooked, boiled, drained, without salt", 0.76, 0.115, 35, 0);
