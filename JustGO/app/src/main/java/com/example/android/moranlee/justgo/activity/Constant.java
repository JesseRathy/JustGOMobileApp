...
/**
 * @author yugu on 2017.07.31
 *         constant class
 */
public class Constant extends select_from_food_database_activity{
   ...
   // public static final String[][] FIGURES = {a.m,a.fruit,a.vegetable,a.dairy};
    ...
    public static final String[][] FIGURES = {a.meat,a.fruit,a.vegetable,a.dairy};
