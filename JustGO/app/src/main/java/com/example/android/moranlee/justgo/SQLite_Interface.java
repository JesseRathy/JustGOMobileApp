...
public class SQLite_Interface {
    ...
    private String [] do_create_table_string(){
        ...
        creating[1] = "create table user (id int primary key not null, name char(50) not null, password char(15) not null, height numeric not null, gender char(1) not null, birthday date not null);";
